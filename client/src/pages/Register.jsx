        ...
        <div className="">
          ...
          <form onSubmit={handleRegisterSubmit}>
            ...
            <div className="relative flex justify-end items-center mb-4">
              <input type="password" name="password" className="py-3 pl-3 pr-10 w-full border rounded-none focus:outline-none focus:border-mblue-700 border" placeholder="Sifre girin" />
              <button className="absolute right-1 text-gray-400 hover:bg-mblue-300 hover:text-mblue-800 rounded-full p-2">
            ...
            <button className="cursor-pointer p-3 mb-4 w-full text-white bg-mblue-500 rounded-none hover:bg-mblue-600 duration-300 drop-shadow-xl">Kayit ol</button>
          </form>
