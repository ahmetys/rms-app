    ...
    <header className="px-2 py-2 md:px-5 md:py-5 mb-5 border cursor-pointer drop-shadow-xl bg-mblue-800 rounded sticky top-0 z-20">
      <div className="flex justify-between lg:justify-end items-center">
        ...
        <div className="flex justify-end space-x-2 items-center">
          ...
          <a onClick={toggleActionsPopup} id="user-icon" className="px-2 py-1 duration-300 text-white hover:bg-mblue-200 hover:text-mblue-950 rounded-full">
      ...
      <div className="relative flex justify-center z-50">
        {/*User Actions*/}
        <div id="user-actions-card" className={actionsPopup + " flex flex-col w-80 absolute md:right-0 border border-mblue-200 mt-4 bg-white rounded drop-shadow-xl"}>
          {/*User Actions Header*/}
          ...
          <div className="flex cursor-pointer p-3 space-x-3">
            ...
            <a href="" onClick={logout} className="text-red-600 font-bold">
              Logout
            </a>
          </div>
        </div>
